                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post"
                          action="{{ URL::to('pmo-admin/saveNewBusinessUnitAttribute') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input id="bua-name" name="bua-name" type="text" required="required" class="form-control col-md-7 col-xs-12" value="{{ old('bu-name') }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <textarea id="bua-description" name="bua-description" class="form-control col-md-7 col-xs-12 rol-attr"></textarea>
                            </div>
                        </div>
